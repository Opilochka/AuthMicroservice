        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedCorsOrigins = table.Column<List<string>>(type: "text[]", nullable: false),
                    AllwedScopes = table.Column<List<string>>(type: "text[]", nullable: false),
